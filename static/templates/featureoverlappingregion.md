```template
id: featureOverlappingRegion
title: Features overlapping a region
description: |
  Find features overlapping a sequence region
valueA_example: "*"
...
url:
  ...
  result: feature
  taxonomy: ncbi
  query: feature_type={valueA} AND sequence_id={valueB} AND end>={valueC} AND start<={valueD}
```
